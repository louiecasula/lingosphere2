...
export const UserProfileDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="lingosphere2App.userProfile.delete.question">
        <Translate contentKey="lingosphere2App.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
