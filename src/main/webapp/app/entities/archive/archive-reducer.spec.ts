...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './archive.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARCHIVE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARCHIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARCHIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARCHIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARCHIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARCHIVE actions', async () => {
      const expectedActions = [
        {
