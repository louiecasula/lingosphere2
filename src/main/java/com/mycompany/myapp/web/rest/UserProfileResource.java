    ...
    public ResponseEntity<UserProfile> partialUpdateUserProfile(
        ...
        Optional<UserProfile> result = userProfileRepository
            ...
            .map(existingUserProfile -> {
                ...
                if (userProfile.getNativeLanguage() != null) {
                    existingUserProfile.setNativeLanguage(userProfile.getNativeLanguage());
                }
                if (userProfile.getTargetLanguage() != null) {
                    existingUserProfile.setTargetLanguage(userProfile.getTargetLanguage());
                }
